...
_device_ int64 modmul(int64 a, int64 b) {
    return (a * b) % mod;
}

_device_ int64 modadd(int64 a, int64 b) {
    return (a + b) % mod;
}

_device_ int64 modsub(int64 a, int64 b) {
    return (a - b + mod) % mod;
}

_host_ _device_ int64 modpow(int64 base, int64 exp, int64 m) {
    int64 res = 1;
    base %= m;
    while (exp > 0) {
...
_global_ void ntt_kernel(int64* a, int n, int64 root, bool invert) {
...
_global_ void pointwise_mult_kernel(int64* A, int64* B, int64* C, int n) {
